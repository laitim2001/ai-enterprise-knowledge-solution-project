...
_RULE_3_DETAILED = (
    ...
    "There is no word limit. PRESERVE THE SOURCE'S GROUPING: keep the source's own "
    "sub-procedure / section group headings (e.g. 'GL03-1. Create General Journal', "
    "'Create General Journal header', 'Prepare excel file', 'Upload excel file') as "
    "group headings and NEST each group's steps beneath it as an indented numbered "
    "sub-list — do NOT flatten the whole procedure into one long single-level "
    "decimal-numbered list. Preserve the source's button / menu / field names verbatim. "
    "The source manuals often repeat the SAME step in more than one form — a "
